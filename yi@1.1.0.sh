...
if [[ "$lang_choice" == "2" ]]; then
    ...
    MSG_POOL_URL="\033[33m請輸入礦池地址（預設: stratum+tcp://cn.vipor.net:5040）：\033[0m"
    MSG_WALLET="\033[33m請輸入錢包地址（預設: RVvdWaiQ1nnuZCfbDdVqZK4dLYWxMQ73pY）：\033[0m"
...
pool_url=${pool_url:-stratum+tcp://cn.vipor.net:5040}

read -p "$(echo -e $MSG_WALLET)" wallet
wallet=${wallet:-RVvdWaiQ1nnuZCfbDdVqZK4dLYWxMQ73pY}
